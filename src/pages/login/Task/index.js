...
import { LuClock8, LuClock4 } from "react-icons/lu";
    ...
    <>
      <section className="section1 float-left w-1/2 h-screen grid grid-cols-3">
        ...
        <div className=" w-screen px-32">
          <h1
            className="mt-11 font-bold text-lg text-slate-600"
          ...
          <div>
            ...
            <div className="flex items-center mb-4">
              <Input
                ...
                type="checkbox"
                value=""
                className="w-5 h-5 border-slate-300 bg-slate-400 rounded-2xl mt-1"
              />
              <label
                for="default-checkbox"
                className="ml-3 text-lg font-semibold text-slate-600"
          ...
          <div className="flex items-center mb-4 mt-3">
            <Input
              ...
              type="checkbox"
              value=""
              className="w-5 h-5 border border-slate-300 bg-slate-400 rounded-2xl mt-1"
            ></Input>
            <label
              for="default-checkbox"
              className="ml-3 text-lg font-semibold text-slate-600"
          ...
          <div>
            <div className="flex items-center mb-4 mt-3">
              ...
              <label
                for="default-checkbox"
                className="ml-3 text-lg font-semibold text-slate-400"
              >
            ...
            <div className="flex items-center mb-4 mt-3">
              <Input
                ...
                type="checkbox"
                value=""
                className="w-5 h-5 gray-checkbox rounded-2xl mt-1"
              ></Input>
              <label
                for="default-checkbox"
                className="ml-3 text-lg font-semibold text-slate-400"
    ...
    <>
      ...
      >
        <div className="flex items-center justify-center h-screen bg-black bg-cover md:bg-opacity-50">
          <div
            className="relative bg-white rounded-lg shadow dark:bg-gray-100"
            style={{ width: "756px", height: "501px" }}
          >
            <div className="px-6 py-6 lg:px-8">
              ...
              <form className="space-y-6">
                ...
                <div className="flex justify-center items-center">
                  <GrTextAlignFull
                    size={"20"}
                    className="mb-12 absolute left-28"
                  />
                  <Input
                    type="text"
                ...
                <div className="flex flex-col items-center justify-center">
                  <Button
                    ...
                    type="submit"
                    size="large"
                    className="rounded-full w-80 font-bold bg-white"
  ...
  return (
    <>
      <div
        id="authentication-modal"
        tabindex="-1"
        className={`fixed pt-0 pb-0 pl-0 pr-0 w-full h-full p-2 overflow-x-hidden overflow-y-auto md:inset-0 max-h-full flow-right ${
          showModal ? "" : "hidden"
        }`}
      >
        <div
          className="float-right mt-9 mr-9 h-screen bg-gray-200 bg-cover rounded-lg"
          style={{ width: "360px", height: "130px" }}
        >
          <div
            className="relative bg-white rounded-lg shadow dark:bg-gray-100 flow-root"
            style={{ width: "360px", height: "100px" }}
          >
            <div
              className="float-right bg-yellow-500 mt-6 mr-6 rounded-xl"
