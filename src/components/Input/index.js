...
const variants = {
     LoginPage: 'items-center justify-center font-medium  rounded-xl w-96 py-2 px-3 text-grey-400 mb-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-100 h-14',
...
export function Input({ variant,checked, type, name, inputId, defaultValue, label, helperText, error, placeholder, value, onChange }) {
    return (
        <div>
